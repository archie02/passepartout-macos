...
class EndpointViewController: NSViewController, ProfileCustomization {
    ...
    override func viewDidLoad() {
        ...
        // FIXME: hosts with multiple addresses deceive user into thinking
        // than selecting a specific host would have any effect
        //
        // either render this in a different way, or actually implement
        // manual address in host profiles
